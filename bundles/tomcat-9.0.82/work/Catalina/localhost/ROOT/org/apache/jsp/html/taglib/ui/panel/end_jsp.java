...
if (collapsible) {
	...
	if (state.equals("open")) {
      ...
      try {
        ...
        // /html/taglib/ui/panel/end.jsp(14,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          try {
            ...
            // /html/taglib/ui/panel/end.jsp(15,1) name = sandbox type = boolean reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_aui_005fscript_005f0.setSandbox( true );
            // /html/taglib/ui/panel/end.jsp(15,1) name = use type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            ...
            if (_jspx_eval_aui_005fscript_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
              ...
              do {
                out.write("\n		var storeTask = A.debounce(Liferay.Store, 100);\n\n		function onPanelHide(event) {\n			if (event.panel.getAttribute('id') === '");
                out.print( id );
                out.write("Content') {\n				var task = {};\n\n				task['");
                out.print( id );
