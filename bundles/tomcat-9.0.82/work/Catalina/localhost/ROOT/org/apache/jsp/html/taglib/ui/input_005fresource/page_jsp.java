...
String url = (String)request.getAttribute("liferay-ui:input-resource:url");
      ...
      out.write("\n\n<input class=\"form-control lfr-input-resource ");
      out.print( GetterUtil.getString((String)request.getAttribute("liferay-ui:input-resource:cssClass")) );
      out.write('"');
      out.write(' ');
      out.print( Validator.isNotNull(id) ? "id=\"" + namespace + id + "\"" : StringPool.BLANK );
      out.write(" onClick=\"this.select();\" disabled ");
