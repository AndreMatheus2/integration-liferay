...
boolean toggleRowChecker = GetterUtil.getBoolean(request.getAttribute("liferay-ui:search-container-column-icon:toggleRowChecker"));
      ...
      try {
        ...
        // /html/taglib/ui/search_container/icon.jsp(15,1) name = image type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_aui_005ficon_005f0.setImage( (String)request.getAttribute("liferay-ui:search-container-column-icon:icon") );
        // /html/taglib/ui/search_container/icon.jsp(15,1) name = markupView type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_aui_005ficon_005f0.setMarkupView("lexicon");
        // /html/taglib/ui/search_container/icon.jsp(15,1) name = url type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_aui_005ficon_005f0.setUrl( (String)request.getAttribute("liferay-ui:search-container-column-icon:href") );
